...
@Profile("!local")
@Component
public class OpenSearchRestClientBuilderProd extends OpenSearchRestClientBuilder {

    OpenSearchRestClientBuilderProd(@Value("${metadata.opensearch.url}") String opensearchUrl) {
        super(opensearchUrl);
    }
